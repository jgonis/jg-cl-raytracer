...
(defmethod element-at ((matrix jg-matrix) (row fixnum) (column fixnum))
...
(defmethod multiply ((mat1 jg-matrix) (mat2 jg-matrix))
  (let* ((cols (columns mat1))
         (rows (rows mat2)) 
         (result-mat (make-jg-matrix cols rows)))
    (dotimes (row cols result-mat)
      (dotimes (col rows result-mat)
        (setf (element-at result-mat row col)
              (+ (* (element-at mat1 row 0) 
                    (element-at mat2 0 col))
                 (* (element-at mat1 row 1)
                    (element-at mat2 1 col))
                 (* (element-at mat1 row 2)
                    (element-at mat2 2 col))
                 (* (element-at mat1 row 3)
                    (element-at mat2 3 col))))))))
